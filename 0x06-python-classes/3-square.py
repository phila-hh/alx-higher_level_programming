...
initializes its size while checking if the given parameter value is correct.
This class also contains an area method that computes the area of the square.
